...
Bounty Board is a Foundry VTT module for managing sci-fi bounty contracts in your game. It gives the GM a place to post bounties and lets players browse available contracts, all presented in a style that fits right into a cyberpunk or space-opera setting.

The module works on its own from the scene controls, and it also integrates with HoloSuite Core if you have it installed, appearing as an app in the HoloSuite launcher.
...
1. Enable **Bounty Board** in your Foundry world.
2. Open the bounty board from the scene controls button, or from the HoloSuite launcher if you have HoloSuite Core enabled.
...
1. Open the bounty board from the scene controls button, or from the HoloSuite launcher if available.
...
- Bounty availability may change during a session as the story develops.
