const MODULE_ID = "security-camera-system";
...
function registerSettings() {
  game.settings.register(MODULE_ID, "cameras", {
    ...
    hint: "World-level camera feed definitions for the Security Camera System module.",
    scope: "world",
    config: false,
    type: Object,
    default: {}
...
function addSceneControlButton(controls) {
  ...
  if (!Array.isArray(controls)) {
    ...
    tokenControls.tools["security-camera-system"] = { ...tool, order };
    return;
  }
